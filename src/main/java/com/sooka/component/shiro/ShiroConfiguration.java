...
import com.sooka.component.shiro.realm.AdminRealm;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilter(@Value("${system.login.path}") String loginPath,
		...
		chains.put("/v2/api-docs", "logout");
		chains.put("/system/cms/content/selectKeyWord", "anon");
		chains.put("/system/cms/content/selectCwhy", "anon");
		chains.put("/system/cms/content/selectZrhy", "anon");
