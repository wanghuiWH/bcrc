...
!function (e) {
    ...
    window.webpackJsonp = function (a, o, r) {
        ...
        if (r) for (l = 0; l < r.length; l++) d = i(i.s = r[l]);
        return d
    };
    var a = {}, n = {2: 0};
    ...
    "use strict";
    window.kwdSearchData = [], window.kwdSearch = function (e) {
        var a = $("#keywordtype").val(), n = new Array("Job"), i = encodeURIComponent($("#" + e).val());
        ...
        var t = arguments[1] ? $(arguments[1]) : $("#kwdselectid"),
            a = arguments[2] ? $(arguments[2]) : $("#KwdSearchResult"), n = a.find("span.li"), i = n.length - 1,
            o = parseInt(t.attr("vindex")), r = e.keyCode, c = "", s = 38 == r, d = 40 == r, l = 39 == r;
        ...
        var t = "00", a = "0000", n = "000000", i = "2", o = "99", r = "99", c = "99", s = "99", d = "99", l = "99",
            _ = "0000";
        ...
        if ("undefined" != typeof manualTrack && "undefined" != typeof window.cfg && ("default.php" == window.cfg.fileName || "default-e.php" == window.cfg.fileName)) {
            var y = {cusParam: "1" + String.fromCharCode(22) + i + String.fromCharCode(22) + $.trim(e) + String.fromCharCode(22) + ("000000" == n ? "" : n)};
        ...
        var t = $("#language").length > 0 ? $("#language").val() : "c",
            a = {1: "e" == t ? "Company" : "公司", 2: "e" == t ? "Full Text" : "全文"},
            n = {1: "e" == t ? "Search Company" : "搜公司", 2: "e" == t ? "Search Full Text" : "搜全文"},
            i = {1: "e" == t ? "Search Company" : "搜索公司名", 2: "e" == t ? "Search Full Text/Job" : "搜索全文/职位名"};
        ...
        var e = arguments[0] ? arguments[0] : "", t = arguments[1] ? arguments[1] : "",
        ...
        var e = {
            ...
            kwdresult: $("#KwdSearchResult"),
            kwdresult1: $("#KwdSearchResult1")
        }, t = $("#keywordtype").val(), a = $("#language").length > 0 ? $("#language").val() : "c";
        switch (t) {
            case"1":
        ...
        $("#kwdTypeSelUl_jobs").hover(function (e) {
            ...
            success: function (e) {
                var t = "";
                if (e.rowcount > 0) for (var a = 0; a < e.rowcount; a++) t += '<div class="inf i2">', t += "<label onclick=\"window.location.href='" + window.cfg.url.i + "/userset/my_searcher.php?lang=c&searchid=" + e[a].searcherid + '\'" title="' + e[a].searchername + '">' + e[a].searchername + "</label>", t += '<a href="' + e[a].searcherurl + '" class="a" title="' + e[a].searcherinfostr + '" target="_blank">' + e[a].searcherinfostr + "</a>", t += "</div>"; else t = '<div class="rno c_666">您还没有个人搜索器<span class="p_but flesh" onclick="window.location.href=\'' + window.cfg.url.i + "/userset/my_searcher.php?lang=c'\">立即创建</span></div>";
            ...
            var a = window.event || arguments[0].originalEvent || t, n = a.srcElement || a.target;
            $.each(e, function (e, t) {
                t.hide()
    ...
    $.extend({
        FLayer: {
            init: function (e) {
                ...
                var t = $(document).scrollLeft(), a = $(document).scrollTop(), n = $(window).width(),
                    i = $(window).height(), o = (n - e.oLayerElement.width()) / 2 + t,
                    r = 382 * (i - e.oLayerElement.height()) / 1e3 + a;
                e.oLayerElement.css({left: Math.max(parseInt(o), t), top: Math.max(parseInt(r), a)})
    ...
    $.extend({
        commonLayer: {
            init: function (e) {
                ...
                var t = '<ul id="' + e.center_left + '" class="sbar">', a = "";
                ...
                e.stopPropagation();
                var t = e.data, a = $(this).attr("data-value");
                ...
                e.stopPropagation();
                var t = e.data, a = $(this).attr("data-value"), n = $(this).attr("data-navigation"),
                    i = jQuery.commonLayer.getSub(t, a);
                if (i.length > 0) if ($(this).hasClass(t.center_right_list_sub_category_each_all)) jQuery.commonLayer.setSelect(t, a, n); else if ($("#" + t.center_right).find("." + t.center_right_list_sub_category).hide(), $("#" + t.center_right_list_sub_category + "_" + n + "_" + a).length > 0) $("#" + t.center_right_list_sub_category + "_" + n + "_" + a).show(); else {
    ...
    $.extend({
        commonSelect: {
            oCurrentSelected: {},
            oSaveCodeTypeSplit: {1: ",", 2: " "},
            oSaveTextTypeSplit: {1: "+", 2: " "},
                ...
                switch (a) {
                    case"1":
                        e.data_multiple ? $.each(jQuery.commonSelect.oCurrentSelected[e.data_type], function (t, a) {
                            n.push({k: a, v: e.data[a]})
                        }) : n.push({k: t, v: e.data[t]});
                        break;
                    case"2":
            ...
            saveText: function (e, t, a) {
                var n = jQuery.commonSelect.getRealData(e, t, a), i = [];
                $.each(n, function (e, t) {
                    i.push(t.v)
                });
                var o = $("#" + e.text_id);
            ...
            getObjectKeys: function (e) {
                var t = [];
                if (e.keys) t = Object.keys(e); else for (var a in e) e.hasOwnProperty(a) && t.push(a);
                return t
            },
    ...
    n = jQuery, i = {
        ...
        return this.each(function () {
            ...
            t.show_ip_location && (t.layer_before_open = function () {
            }, t.layer_after_open = c), n(this).bind("click", t, t.data_click)
        });
        ...
        function c(e) {
            if (0 == n("#" + e.id + "_ip_location").length) {
                var t = "undefined" == typeof window.cfg || "undefined" == typeof window.cfg.domain || "undefined" == typeof window.cfg.domain.i ? "" : window.cfg.domain.i;
    ...
    n = jQuery, i = {
                ...
                case"3":
                    r = {}, n.each(t.data, function (e, t) {
                        if ("00" == e.substr(e.length - 2, 2)) {
                            var a = e.substr(0, 2) + "0000", n = e.substr(0, 4) + "00";
        ...
        var t = {}, a = {
            ...
            append_fn: function (e) {
                e.stopPropagation();
                var t = e.data, a = n.trim(n("#" + t.text_id).val());
            ...
            saveEvent: function (e) {
                e.stopPropagation();
                var t = e.data, a = n(this).attr("data-value");
    ...
    $.extend({
        commonAssociation: {
            ParentCategory: {}, ChildCategory: {}, ChildChildCategory: {}, init: function (e) {
                ...
                if (jQuery.commonAssociation.upDownEvent(e)) {
                    ...
                    var a = $("#" + t.text_id), n = ($("#" + t.code_id), $.trim(a.val()));
                ...
                e.stopPropagation();
                var t = e.data, a = $.trim($("#" + t.text_id).val());
                ...
                switch (e.data_child_depth) {
                    ...
                    case"3":
                        0 == jQuery.commonSelect.getObjectKeys(e.ParentCategory).length && $.each(e.data, function (t, a) {
                            ...
                            } else "00" == t.substr(4, 2) ? e.ChildCategory[t] = a : e.ChildChildCategory[t] = a
                        })
                }
                var a = {parent_category: [], child_category: [], childchild_category: []}, n = t.toLowerCase();
                ...
                switch (e.data_child_depth) {
                    ...
                    case"3":
                        $.each(a.parent_category, function (e, t) {
                            ...
                            if (-1 == o.toString().indexOf(t)) {
                                var a = t.substr(0, 4) + "00", n = t.substr(0, 2) + "0000";
                ...
                $.ajax({
                    url: "",
                    data: {kwd: t, src: e.data_type, rand: Math.random()},
                    dataType: "jsonp",
                    cache: !1,
                    async: !1,
                    timeout: 1e3,
                ...
                var a = e.keyCode, n = $("#" + t.association_id), i = $("#" + t.association_id).find("span.on");
                switch (a) {
                    case 38:
                    ...
                    case 13:
                        ...
                        return i.hasClass("tl") ? i.children().click() : i.click(), !1;
                    default:
                        return !0
                }
                ...
                if (jQuery.FLayer.close(t), $(t.self_define_text_id + "_selfdefine_div").length > 0) $(t.self_define_text_id + "_selfdefine_div").show(); else {
                    ...
                    var a = $("#" + t.self_define_text_id + "_selfdefine_input"), n = a.val();
    ...
    "use strict";
    "undefined" == typeof window.lang && (window.lang = []), window.lang.funtype = {layer_name: "职能"}, window.lang.indtype = {layer_name: "行业"}, window.lang.cert = {
        layer_name: "证书",
