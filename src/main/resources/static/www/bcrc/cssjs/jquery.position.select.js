...
------------------------------ */
    ...
    $.fn.positionSelect = function (settings) {
        ...
        function init(setting) {
            ...
            if (setting.className != null) {
                container.addClass(setting.className);
            }
            ...
            if ($.trim(container.html()) == "") {
                ...
                $("#" + num + "_datalist #firstMenu ul li").bind("mouseover", function () {
                    ...
                    secondMenu.find("a").bind("click", function () {
                        ...
                        if ($(this).hasClass("sele")) {
                            ...
                            if (selectedCount >= setting.maxCount) {
                                container.find("#tip_" + num).html("最多只能选择" + setting.maxCount + "项！").css("color", "red");
                                setTimeout(function () {
                ...
                // 确定
                container.find("#ddResult_" + num + " a[id='btnSure_" + num + "']").click(function () {
